...
<!--  <form name="detailForm" method="post" enctype="multipart/form-data"> 2022-03-31 shhwang--> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<input	type="text" name="fileName" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="<%=vo.getFileName() %>"/> <!-- 2022-04-02 shhwang -->
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						...
						<!--  <a href="javascript:fncAddProduct();">수정</a> -->
						<!--  <a href="javascript:fncAddProduct();">수정</a>-->
						<!--  <a href="/getProduct.do?prodNo=<%=vo.getProdNo() %>">수정</a>--><!-- 2022-04-07 --> 
						<a href="javascript:fncAddProduct();">수정</a><!-- 2022-04-07 --> 
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						...
						<a href="javascript:history.go(-1)">취소</a><!-- 2022-04-14 shhwang -->
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
					</td>
